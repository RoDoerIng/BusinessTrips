    ...
    public class BusinessTripsContext : DbContext
    {
        ...
        protected override void OnModelCreating(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<Trip>().HasData(
                new { TripId = 1, Distance = 2.3, Date = DateTime.Now.AddYears(-30), StartAddressAddressId = 1, DestinationAddressAddressId = 2 },
                new { TripId = 2, Distance = 4.0, Date = DateTime.Now.AddYears(-10), StartAddressAddressId = 2, DestinationAddressAddressId = 3 },
                new { TripId = 3, Distance = 1.9, Date = DateTime.Now.AddDays(-455), StartAddressAddressId = 3, DestinationAddressAddressId = 1 });
        }
